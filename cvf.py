...
class cvf(object):
    ...
    def getspp(self):
        return self.inputJson['sppTarget']
    
    def getRD(self):
        return self.inputJson['rayDepth']
    
    def getWidth(self):
        return self.inputJson['width']
    
    def getHeight(self):
        return self.inputJson['height']
    ...
    def setspp(self, fl):
        self.inputJson['sppTarget'] = fl
    
    def setRD(self, fl):
        self.inputJson['rayDepth'] = fl
        
    def setWidth(self, fl):
        self.inputJson['width'] = fl
    
    def setHeight(self, fl):
        self.inputJson['height'] = fl
    ...
    def setsaveSnapshots(self):
        self.inputJson['saveSnapshots'] = 'true'
    ...
    def __init__(self, name):
        self.filename = name
        inputJsonString = open(os.path.join('source',name)).read()
